  ...
  return (
    ...
    {/* <!-- Flex Container--> */}
      <div class="container flex flex-col-reverse items-center px-3 mx-auto mt-1 space-y-0 md:flex-row md:space-y-0 md:space-x-2">
        {/* <!-- Left Item --> */}
         <div class="relative flex flex-col mb-32 space-y-6 md:max-w-md">
          <h1 class="max-w-md text-4xl font-bold text-white text-center md:text-5xl md:text-left">
            Welcome to Meet Pay Platform
          </h1>
          <p class="max-w-sm text-center text-gray-500 space-y-5 md:text-start md:text-gray-200">
            ...
            <br />
            <span className='text-4xl text-white'>COMING SOON...</span>
          </p>
         ...
         {/* <!-- Image --> */}
          <div className='flex flex-col items-center relative'>
            ...
            <div class=" max-w-md md:max-w-lg ">
              <Link to={"/wallet"}>
              <img src={walletImage} alt="Do That Later" className='drop-shadow-2xl hover:scale-[1.1]' /> 
              </Link>
            </div>
            <div className="hidden absolute bottom-0 right-[-55px] max-w-14 md:block">
              <img src={Vase} alt="" className='drop-shadow-2xl'/>
            </div>
            <div className="hidden absolute bottom-25 right-[-64px] max-w-20 md:block">
              <img src={YellowFlower} alt="" className='drop-shadow-2xl' />
            </div>
          </div>
      </div>
   </section>
